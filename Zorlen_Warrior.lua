...
-- 		return
-- 	elseif string.find(arg1, Zorlen_gsub(LOCALIZATION_ZORLEN.Hamstring, TargetName)) then
-- 		Zorlen_debug("Target is immune to "..LOCALIZATION_ZORLEN.Hamstring.."!")
-- 		Zorlen_WasHamstringSpellCastImmune = 1
-- 		Zorlen_SetTimer(7, LOCALIZATION_ZORLEN.Hamstring, "immune", "InternalZorlenMiscTimer")
-- 	elseif string.find(arg1, Zorlen_gsub(LOCALIZATION_ZORLEN.SunderArmor, TargetName)) then
...
-- 	elseif string.find(arg1, Zorlen_gsub(LOCALIZATION_ZORLEN.Rend, TargetName)) then
