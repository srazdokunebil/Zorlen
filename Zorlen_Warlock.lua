...
function isSacrificeActive()
	return Zorlen_checkBuff("Spell_Shadow_SacrificialShield")
end

function isFelDominationActive()
	return Zorlen_checkBuff("Spell_Nature_RemoveCurse")
end

function isFelDomination()
	return Zorlen_checkBuff("Spell_Nature_RemoveCurse")
end
...
function isShadowWardActive()
	return Zorlen_checkBuff("Spell_Shadow_AntiShadow")
end
...
function isTouchofShadowActive()
	return Zorlen_checkBuff("Spell_Shadow_PsychicScream")
end
